...
public class LoadProperties {
	...
	public static String getAPIURL() {
		String apiURL = System.getProperty("reservation.api.url") == null ? 
				LoadProperties.getProperty("reservation.api.url") : System.getProperty("reservation.api.url");
